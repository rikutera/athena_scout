...
const HowToPage = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        {
          question: 'メッセージ生成時にエラーが発生した場合はどうすればいいですか？',
          answer: (
            <>
              <p>エラーメッセージに応じて、以下の対処を行ってください：</p>
              <ul>
                <li><strong>「Claude APIが過負荷状態です」と表示された場合</strong>：
                  <ul>
                    <li>AIサービスが一時的に混雑している状態です。</li>
                    <li>5〜10分ほど時間をおいてから再度お試しください。</li>
                    <li>繰り返し発生する場合は、時間帯を変えてご利用ください。</li>
                  </ul>
                </li>
                <li><strong>「APIの利用制限に達しました」と表示された場合</strong>：
                  <ul>
                    <li>短時間に多数のリクエストが発生しています。</li>
                    <li>数分間待ってから再度お試しください。</li>
                  </ul>
                </li>
                <li><strong>「サーバーに接続できませんでした」と表示された場合</strong>：
                  <ul>
                    <li>インターネット接続を確認してください。</li>
                    <li>ブラウザを再読み込みしてください。</li>
                  </ul>
                </li>
                <li><strong>上記の対処で改善しない場合</strong>：
                  <ul>
                    <li>エラーメッセージのスクリーンショットを撮影してください。</li>
                    <li>Slackで管理者に問い合わせてください。</li>
                  </ul>
                </li>
              </ul>
            </>
        ...
        },
        {
          ...
          answer: (
            <>
              ...
              <ul>
                <li><strong>警告表示</strong>：タイムアウトの5分前に警告が表示されます。</li>
      ...
      items: [
        {
          ...
          answer: (
            <>
              <ul>
                <li><strong>必ず内容を確認</strong>：AIが生成したメッセージは必ず自身で確認し、適切性を判断してください。</li>
                <li><strong>学生ごとに反映</strong>：生成されたコメントは、必ず学生ごとに反映し、学生と生成コメントを間違わないようにしてください。</li>
